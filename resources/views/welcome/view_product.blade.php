    ...
    <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
      ...
      <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
			<div class="slider slider-for">
				<div class="w-full relative overflow-hidden" style="height:26rem">
          ...
          <img class="absolute inset-0 h-full w-full object-cover"
			...
			<div class="slider slider-nav">
				<div class="w-full relative pb-40 overflow-hidden">
          <img  class="absolute inset-0 my-4 mx-2 h-full w-full object-cover"
                src="https://images.unsplash.com/photo-1611235115922-72aece5cf686?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
                alt="">
				</div>
				<div class="w-full relative pb-40 overflow-hidden">
